...
const LesDetails = () => {
  ...
  if (route.params) {
    ...
    return (
      <View>
        <ScrollView style={styles.bgDark}>
          <View>
            <View>
              <Text style={styles.lesDetailsBody}>  {data.name ? "Name : " + data.name : ""}</Text>
            </View>
            <View>
              <Pressable onPress={() => {
            ...
            <View>
              <Text style={styles.lesDetailsBody}>  {data.genre ? "Genre : " + data.genre : ""}</Text>
            </View>
            <View>
              <Text style={styles.lesDetailsBody}>  {data.type ? "Type :" + data.type : ""}</Text>
            </View>
          </View>
    ...
    return (
      <View>
        <Text style={styles.title}>Sélectionnez un artiste ou track dans la liste</Text>
      </View>
    )
  }
